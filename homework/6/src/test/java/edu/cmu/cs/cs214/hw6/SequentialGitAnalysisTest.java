...
public class SequentialGitAnalysisTest {
    private static final String PATH_NAME = "/Users/yiyiren/churn-rate-example/.git";
    private SequentialGitAnalysis analysis;

    @Before
    public void setUp() throws Exception {
        analysis = new SequentialGitAnalysis(new File(PATH_NAME));
        analysis.getDevelopmentHistory();
    }

    @Test
    public void getChildCommits() throws Exception {
        List<String> childCommits = analysis.getChildCommits();
    ...
    public void getParentCommits() throws Exception {
        List<String> parentCommits = analysis.getParentCommits();
    ...
    public void getNumOfLines() throws Exception {
        List<Integer> numOfLines = analysis.getNumOfLines();
