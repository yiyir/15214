...
public class StreamTest {
    ...
    @Test
    public void testFirstFibStartingFrom() {
        assertEquals(BigInteger.valueOf(13), firstFibStartingFrom(BigInteger.TEN));
        assertEquals(BigInteger.valueOf(10946), firstFibStartingFrom(BigInteger.TEN.pow(4)));
    }
